<template>
  <div class="cool-field-demo">
    <!-- 头部介绍 -->
    <div class="demo-header">
      <h1>🎯 CoolField 统一字段组件</h1>
      <p class="demo-desc">
        基于 Vue 3 + TypeScript + Ant Design Vue 的统一字段组件，支持 30+ 种字段类型，
    ...
    <section class="demo-section">
      ...
      <div class="demo-grid">
        ...
        <div class="demo-card">
          ...
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>只读模式</label>
                <CoolField value-type="text" mode="read" :value="demoData.text" />
              </div>
              <div class="demo-col">
                <label>编辑模式</label>
                <CoolField 
        ...
        <!-- <div class="demo-card">
          ...
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>只读模式</label>
                <CoolField value-type="password" mode="read" :value="demoData.password" />
              </div>
              <div class="demo-col">
                <label>编辑模式</label>
                <CoolField 
                  value-type="password" 
                  mode="edit" 
                  v-model:value="demoData.password"
                  placeholder="请输入密码"
                />
              </div>
            </div>
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>textarea - 多行文本</h3>
            <span class="type-tag">textarea</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>只读模式</label>
                <CoolField value-type="textarea" mode="read" :value="demoData.textarea" />
              </div>
              <div class="demo-col">
                <label>编辑模式</label>
                <CoolField 
                  value-type="textarea" 
                  mode="edit" 
                  v-model:value="demoData.textarea"
                  placeholder="请输入多行文本"
                  :rows="3"
                />
              </div>
    ...
    <section class="demo-section">
      <div class="section-header">
        <h2>🔢 数字类字段</h2>
        <span class="section-badge">4 种类型</span>
      </div>
      ...
      <div class="demo-grid">
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>digit - 整数</h3>
            <span class="type-tag">digit</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>只读模式</label>
                <CoolField value-type="digit" mode="read" :value="demoData.digit" />
              </div>
              <div class="demo-col">
                <label>编辑模式</label>
                <CoolField 
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>digitRange - 整数区间</h3>
            <span class="type-tag highlight">digitRange</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>只读模式</label>
                <CoolField value-type="digitRange" mode="read" :value="demoData.digitRange" />
              </div>
              <div class="demo-col">
                <label>编辑模式</label>
                <CoolField 
                  value-type="digitRange" 
                  mode="edit" 
                  v-model:value="demoData.digitRange"
                  min-placeholder="最小值"
                  max-placeholder="最大值"
                  separator=" ～ "
                />
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>money - 金额</h3>
            <span class="type-tag">money</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>只读模式</label>
                <CoolField 
                  :value-type="{ type: 'money', currency: '¥', precision: 2 }" 
                  mode="read" 
                  :value="demoData.money" 
                />
              </div>
              <div class="demo-col">
                <label>编辑模式</label>
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>percent - 百分比</h3>
            <span class="type-tag">percent</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>只读模式</label>
                <CoolField 
                  :value-type="{ type: 'percent', precision: 1, showColor: true }" 
                  mode="read" 
                  :value="demoData.percent" 
                />
              </div>
              <div class="demo-col">
                <label>编辑模式</label>
                <CoolField 
                  :value-type="{ type: 'percent', precision: 1 }" 
                  mode="edit" 
                  v-model:value="demoData.percent"
                  placeholder="请输入百分比"
                />
              </div>
            </div>
      ...
      <div class="demo-grid">
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>select - 下拉选择</h3>
            <span class="type-tag">select</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>checkbox - 复选框</h3>
            <span class="type-tag">checkbox</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>只读模式</label>
                <CoolField value-type="checkbox" mode="read" :value="demoData.checkbox" />
              </div>
              <div class="demo-col">
                <label>编辑模式</label>
                <CoolField 
                  ...
                  v-model:value="demoData.checkbox"
                />
              </div>
            </div>
          </div>
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>radio - 单选框</h3>
            <span class="type-tag">radio</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
    ...
    <section class="demo-section">
      <div class="section-header">
        <h2>📅 日期时间类字段</h2>
        <span class="section-badge">8 种场景</span>
      </div>
      ...
      <div class="demo-grid">
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>timeRange - 时间范围选择</h3>
            <span class="type-tag">timeRange</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
              ...
              <div class="demo-col">
                ...
                <CoolField 
                  value-type="timeRange" 
                  mode="edit" 
                  v-model:value="demoData.timeRange"
                  format="HH:mm:ss"
                />
              </div>
            </div>
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>timeRange - 时间范围（12小时制）</h3>
            <span class="type-tag highlight">timeRange + use12Hours</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                ...
                <CoolField 
                  value-type="timeRange" 
                  mode="read" 
                  :value="demoData.timeRange12Hours"
                  use12Hours
                  format="h:mm:ss A"
                />
              </div>
              <div class="demo-col">
                ...
                <CoolField 
                  value-type="timeRange" 
                  mode="edit" 
                  v-model:value="demoData.timeRange12Hours"
                  use12Hours
                  format="h:mm:ss A"
                />
              </div>
    ...
    <section class="demo-section">
      ...
      <div class="demo-grid">
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>progress - 进度条</h3>
            <span class="type-tag">progress</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>只读模式</label>
                <CoolField 
                  :value-type="{ type: 'progress', showInfo: true, strokeColor: '#1890ff' }" 
                  mode="read" 
                  :value="demoData.progress" 
                />
              </div>
              <div class="demo-col">
                <label>编辑模式</label>
                <CoolField 
                  :value-type="{ type: 'progress' }" 
                  mode="edit" 
                  v-model:value="demoData.progress"
                  placeholder="请输入进度值"
                />
              </div>
            </div>
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>avatar - 头像</h3>
            <span class="type-tag">avatar</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>只读模式</label>
                <CoolField value-type="avatar" mode="read" :value="demoData.avatar" />
              </div>
              <div class="demo-col">
                <label>编辑模式</label>
                <CoolField 
        ...
        <div class="demo-card">
          ...
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>只读模式</label>
                <CoolField value-type="image" mode="read" :value="demoData.image" />
              </div>
              <div class="demo-col">
                <label>编辑模式</label>
                <CoolField 
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>color - 颜色</h3>
            <span class="type-tag">color</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>只读模式</label>
                <CoolField value-type="color" mode="read" :value="demoData.color" />
              </div>
              <div class="demo-col">
                <label>编辑模式</label>
                <CoolField 
        ...
        <div class="demo-card">
          ...
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>只读模式</label>
                <CoolField value-type="tag" mode="read" :value="demoData.tag" />
              </div>
              <div class="demo-col">
                <label>编辑模式</label>
                <CoolField 
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>badge - 徽章</h3>
            <span class="type-tag">badge</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>只读模式</label>
                <CoolField value-type="badge" mode="read" :value="demoData.badge" />
              </div>
              <div class="demo-col">
                <label>编辑模式</label>
                <CoolField 
    ...
    <section class="demo-section">
      <div class="section-header">
        <h2>⚡ 高级特性</h2>
        <span class="section-badge">透传机制</span>
      </div>
      ...
      <div class="demo-grid">
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>空值处理</h3>
            <span class="type-tag">emptyText</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                <label>默认空值显示</label>
                <CoolField value-type="text" mode="read" :value="null" />
              </div>
              <div class="demo-col">
                <label>自定义空值文本</label>
                <CoolField 
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>属性透传</h3>
            <span class="type-tag">props</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                ...
                <CoolField 
                  value-type="text" 
                  mode="edit" 
                  v-model:value="demoData.textWithIcon"
                  placeholder="请输入文本"
                  prefix="🔍"
                  allow-clear
                />
              ...
              <div class="demo-col">
                ...
                <CoolField 
                  value-type="text" 
                  mode="edit" 
                  v-model:value="demoData.textLarge"
                  placeholder="大尺寸输入框"
                  size="large"
                />
              </div>
        ...
        <div class="demo-card">
          <div class="card-header">
            <h3>事件透传</h3>
            <span class="type-tag">events</span>
          </div>
          <div class="card-content">
            <div class="demo-row">
              <div class="demo-col">
                ...
                <CoolField 
                  value-type="text" 
                  mode="edit" 
                  v-model:value="demoData.textWithEvents"
...
const demoData = reactive({
  ...
  number: 123.45,
  digit: 888,
  digitRange: [10, 100] as [number, number],
  money: 1234.56,
  percent: 85.7,
  ...
  timeRange12Hours: ['9:00:00 AM', '6:00:00 PM'],
...
const handleFocus = () => {
  ...
  eventLogs.value.unshift(`${now} - Focus 事件触发`)
...
const handleBlur = () => {
  const now = new Date().toLocaleTimeString()
  eventLogs.value.unshift(`${now} - Blur 事件触发`)
  if (eventLogs.value.length > 5) {
    eventLogs.value.pop()
  }
}
...
const handleChange = (value: any) => {
  const now = new Date().toLocaleTimeString()
  eventLogs.value.unshift(`${now} - Change 事件: ${value}`)
  if (eventLogs.value.length > 5) {
    eventLogs.value.pop()
  }
}
